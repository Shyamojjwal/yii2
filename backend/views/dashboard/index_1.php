        ...
        <div class="page-bar">
            ...
            <div class="page-toolbar">
                <div id="" class="pull-right tooltips btn btn-fit-height grey-salt" data-placement="top" data-original-title="Change dashboard date range">
                    <i class="icon-calendar"></i>&nbsp; <span class="uppercase visible-lg-inline-block"><?= date_format(date_create(date('Y-m-d H:i:s')), 'g:ia \o\n l jS F Y'); ?></span>&nbsp;
                </div>
            </div>
        </div>
        <!-- END PAGE HEADER-->
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        <div id="site_statistics_loading">
                            <img src="<?= $this->context->getStaticImages('loading.gif') ?>" alt="loading"/>
                            <!--<img src="<?= Yii::$app->request->baseUrl . '/global/assets/' ?>img/loading.gif" alt="loading"/>-->
                        </div>
                                ...
                                <div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
                                    <div class="row">
                                        <div class="col-md-6 user-info">
                                            <img alt="" src="<?= $this->context->getStaticImages('avatar.png')?>" class="img-responsive"/>
                                            <div class="details">
                                                <div>
                                                    <a href="javascript:;">
                                                        Robert Nilson </a>
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body" id="chats">
                        <div class="scroller" style="height: 341px;" data-always-visible="1" data-rail-visible1="1">
                            <ul class="chats">
                                <li class="in">
                                    <img class="avatar" alt="" src="<?= $this->context->getStaticImages('avatar1.jpg')?>"/>
                                    <div class="message">
                                        <span class="arrow">
                                        </span>
                                ...
                                <li class="out">
                                    <img class="avatar" alt="" src="<?= $this->context->getStaticImages('avatar2.jpg')?>"/>
                                    <div class="message">
                                        <span class="arrow">
                                        </span>
                                        <a href="javascript:;" class="name">
                                ...
                                <li class="out">
                                    <img class="avatar" alt="" src="<?= $this->context->getStaticImages('avatar3.jpg')?>"/>
                                    <div class="message">
                                        <span class="arrow">
                                        </span>
                                        <a href="javascript:;" class="name">
